...
const i18n = (() => {
    ...
    const translations = {
        en: {
            ...
            'checkout.shipping_subtitle': 'Enter your delivery information',
            'checkout.delivery_address': 'Delivery Address',
            'checkout.edit': 'Edit',
            'checkout.save_address': 'Save Address',
            'checkout.contact_info': 'Contact Information',
            'checkout.delivery_info': 'Delivery Address',
            'checkout.progress_shipping': 'Shipping',
            'checkout.progress_payment': 'Payment',
            'checkout.progress_confirm': 'Confirm',
            'checkout.order_notes': 'Order Notes (Optional)',
            'checkout.notes_placeholder': 'Special instructions for delivery...',
            'checkout.payment_method': 'Payment Method',
            'checkout.manual_payment': 'Manual Payment',
            'checkout.manual_payment_desc': 'We will contact you to arrange payment after placing your order',
            ...
            'checkout.country_locked': 'Cambodia only',
            'checkout.province': 'Province / City',
            'checkout.district': 'District / Khan / Srok',
            'checkout.commune': 'Commune / Sangkat',
            'checkout.village': 'Village / Phum (Optional)',
            'checkout.combo_placeholder': 'Select or type to search',
            'checkout.village_placeholder': 'Type to search your village',
            'checkout.loading_villages': 'Loading villages...',
            'checkout.no_matches': 'No matches found',
            'checkout.address_incomplete': 'Please select province, district and commune for your delivery address',
            'checkout.add_new_address': 'Use Different Address',
            'checkout.use_saved_address': 'Back to Saved Address',
            ...
            'checkout.awaiting_payment': 'Awaiting Payment',
            'checkout.order_placed_title': 'Order Placed!',
            'checkout.scan_khqr_hint': 'Scan KHQR below & send payment receipt to admin',
            'checkout.amount_due': 'Amount Due',
            'checkout.order_reference': 'Order Reference',
            'checkout.scan_qr_step': 'Scan QR',
            'checkout.pay_step': 'Pay',
            'checkout.send_proof_step': 'Send Proof',
            'checkout.send_proof_btn': 'Send Payment Proof to Admin',
            'checkout.copy_msg': 'Copy',
            'checkout.copied': 'Copied!',
            'checkout.autofill_hint': 'Auto-fills Order #{ref} details in Telegram chat',
            'checkout.keep_shopping': 'Keep Shopping',
            'checkout.copy_order_id': 'Click to copy Order ID',
            'checkout.back_to_checkout': 'Back to checkout',
            ...
            'about.subtitle': 'Cambodia\'s trusted online marketplace — quality products, fair prices, fast delivery nationwide.',
            'about.story_title': 'Our Story',
            'about.story_1': 'BuyBIBZ was founded in 2024 in Phnom Penh, Cambodia, with a clear mission: to bring convenient, affordable, and trustworthy online shopping to Cambodian consumers. We saw that many shoppers struggled with unreliable sellers, overpriced products, and slow deliveries — so we built something better.',
            'about.story_2': 'Today, BuyBIBZ serves customers across all 25 provinces of Cambodia, offering thousands of carefully curated products — from electronics and fashion to home essentials and beauty. We work directly with trusted suppliers and brands to guarantee authentic products at competitive prices, with delivery in 10–13 days.',
            'about.mission_title': 'Our Mission',
            'about.mission_desc': 'To empower Cambodian shoppers with a modern, reliable, and user-friendly e-commerce platform that offers genuine products at fair prices — making quality shopping accessible to everyone, everywhere in Cambodia.',
            'about.vision_title': 'Our Vision',
            'about.vision_desc': 'To become Cambodia\'s leading e-commerce platform, trusted by millions of customers for quality, convenience, and value — while supporting local businesses and contributing to the growth of the digital economy in Southeast Asia.',
            'about.quality_title': '100% Authentic',
            'about.quality_desc': 'Every product is sourced directly from verified suppliers and brands. We guarantee authenticity and quality on every order.',
            'about.delivery_title': 'Nationwide Delivery',
            'about.delivery_desc': 'Fast delivery to all 25 provinces. Phnom Penh orders arrive in 10–12 days, provinces in 12–13 days.',
            'about.customer_title': '24/7 Support',
            'about.customer_desc': 'Our dedicated customer service team is available via phone, email, and Telegram to help you with any questions or issues.',
            'about.offer_title': 'What We Offer',
            'about.offer_electronics': 'Electronics & Gadgets',
            'about.offer_electronics_desc': 'Phones, accessories, smart devices',
            'about.offer_fashion': 'Fashion & Apparel',
            'about.offer_fashion_desc': 'Clothing, shoes, bags & watches',
            'about.offer_home': 'Home & Living',
            'about.offer_home_desc': 'Furniture, kitchen, home décor',
            'about.offer_beauty': 'Health & Beauty',
            'about.offer_beauty_desc': 'Skincare, cosmetics, wellness',
            'about.payment_title': 'Payment Methods',
            'about.payment_desc': 'We support the most popular payment methods in Cambodia for your convenience:',
            'about.happy_customers': 'Happy Customers',
            'about.products': 'Products',
            'about.provinces_covered': 'Provinces Covered',
            'about.support_available': 'Support Available',
            'about.contact_title': 'Contact & Location',
            'about.address_label': 'Address',
            'about.address_value': 'Phnom Penh, Cambodia',
            'about.phone_label': 'Phone',
            'about.email_label': 'Email',
            'about.hours_label': 'Business Hours',
            'about.hours_value': 'Mon–Sat: 8:00 AM – 8:00 PM<br>Sunday: 9:00 AM – 6:00 PM',
            'about.cta_title': 'Ready to Start Shopping?',
            'about.cta_desc': 'Join thousands of happy customers — browse our collection and find your next favorite product.',
            ...
            'cs.faq_4_a': 'Delivery typically takes 10–13 days depending on your location. Phnom Penh orders usually arrive within 10–12 days, provinces 12–13 days.',
        ...
        km: {
            ...
            'checkout.shipping_subtitle': 'បញ្ចូលព័ត៌មានការដឹកជញ្ជូនរបស់អ្នក',
            'checkout.delivery_address': 'អាសយដ្ឋានដឹកជញ្ជូន',
            'checkout.edit': 'កែប្រែ',
            'checkout.save_address': 'រក្សាទុកអាសយដ្ឋាន',
            'checkout.contact_info': 'ព័ត៌មានទំនាក់ទំនង',
            'checkout.delivery_info': 'អាសយដ្ឋានដឹកជញ្ជូន',
            'checkout.progress_shipping': 'ការដឹកជញ្ជូន',
            'checkout.progress_payment': 'ការបង់ប្រាក់',
            'checkout.progress_confirm': 'បញ្ជាក់',
            ...
            'checkout.manual_payment': 'ការបង់ប្រាក់ដោយផ្ទាល់',
            'checkout.manual_payment_desc': 'យើងនឹងទាក់ទងអ្នកដើម្បីរៀបចំការបង់ប្រាក់បន្ទាប់ពីបញ្ជាទិញរបស់អ្នក',
            ...
            'checkout.street': 'អាសយដ្ឋាន / លេខផ្ទះ',
            'checkout.city': 'ទីក្រុង',
            'checkout.postal': 'លេខកូដប្រៃសណីយ៍ (ស្រេចចិត្ត)',
            'checkout.country': 'ប្រទេស',
            'checkout.country_locked': 'កម្ពុជាតែប៉ុណ្ណោះ',
            'checkout.province': 'ខេត្ត / រាជធានី',
            'checkout.district': 'ស្រុក / ខ័ណ្ឌ / ក្រុង',
            'checkout.commune': 'ឃុំ / សង្កាត់',
            'checkout.village': 'ភូមិ (ស្រេចចិត្ត)',
            'checkout.combo_placeholder': 'ជ្រើសរើស ឬបញ្ចូលដើម្បីស្វែងរក',
            'checkout.village_placeholder': 'បញ្ចូលដើម្បីស្វែងរកភូមិរបស់អ្នក',
            'checkout.loading_villages': 'កំពុងផ្ទុកភូមិ...',
            'checkout.no_matches': 'រកមិនឃើញ',
            'checkout.address_incomplete': 'សូមជ្រើសរើសខេត្ត ស្រុក និងឃុំ សម្រាប់អាសយដ្ឋានដឹកជញ្ជូន',
            'checkout.add_new_address': 'ប្រើអាសយដ្ឋានផ្សេង',
            'checkout.use_saved_address': 'ត្រឡប់ទៅអាសយដ្ឋានដែលបានរក្សាទុក',
            ...
            // Payment success screen
            'checkout.awaiting_payment': 'រង់ចាំការបង់ប្រាក់',
            'checkout.order_placed_title': 'ការបញ្ជាទិញបានដាក់ហើយ!',
            'checkout.scan_khqr_hint': 'ស្កែន KHQR ខាងក្រោម ហើយផ្ញើបង្កាន់ដៃការបង់ប្រាក់ទៅ Admin',
            'checkout.amount_due': 'ចំនួនត្រូវបង់',
            'checkout.order_reference': 'លេខយោងការបញ្ជាទិញ',
            'checkout.scan_qr_step': 'ស្កែន QR',
            'checkout.pay_step': 'បង់ប្រាក់',
            'checkout.send_proof_step': 'ផ្ញើបង្កាន់ដៃ',
            'checkout.send_proof_btn': 'ផ្ញើបង្កាន់ដៃការបង់ប្រាក់ទៅ Admin',
            'checkout.copy_msg': 'ចម្លង',
            'checkout.copied': 'បានចម្លង!',
            'checkout.autofill_hint': 'បំពេញព័ត៌មានការបញ្ជាទិញ #{ref} ស្វ័យប្រវត្តិក្នុង Telegram',
            'checkout.keep_shopping': 'បន្តទិញទំនិញ',
            'checkout.copy_order_id': 'ចុចដើម្បីចម្លងលេខបញ្ជាទិញ',
            'checkout.back_to_checkout': 'ត្រឡប់ទៅការទូទាត់',
            ...
            'about.subtitle': 'ទីផ្សារអនឡាញដែលអ្នកទុកចិត្តបាននៅកម្ពុជា — ផលិតផលមានគុណភាព តម្លៃសមរម្យ ដឹកជញ្ជូនរហ័សទូទាំងប្រទេស។',
            'about.story_title': 'រឿងរ៉ាវរបស់យើង',
            'about.story_1': 'BuyBIBZ ត្រូវបានបង្កើតឡើងក្នុងឆ្នាំ 2024 នៅរាជធានីភ្នំពេញ ប្រទេសកម្ពុជា ដោយមានបេសកកម្មច្បាស់លាស់៖ នាំយកបទពិសោធន៍ទិញទំនិញអនឡាញដែលជាងាយស្រួល មានតម្លៃសមរម្យ និងគួរឱ្យទុកចិត្តដល់អ្នកប្រើប្រាស់កម្ពុជា។',
            'about.story_2': 'បច្ចុប្បន្ន BuyBIBZ បម្រើអតិថិជននៅគ្រប់ 25 រាជធានី-ខេត្ត ដោយផ្តល់ជូននូវផលិតផលប្រកបដោយគុណភាពរាប់ពាន់មុខ — ចាប់ពីឧបករណ៍អេឡិចត្រូនិក សម្លៀកបំពាក់ រហូតដល់សម្ភារៈប្រើប្រាស់ក្នុងផ្ទះ និងផលិតផលថែរក្សាសម្ផស្ស ជាមួយការដឹកជញ្ជូនក្នុងរយៈពេល 1-5 ថ្ងៃធ្វើការ។',
            'about.mission_title': 'បេសកកម្មរបស់យើង',
            'about.mission_desc': 'ផ្តល់ជូនអតិថិជនកម្ពុជានូវវេទិកាពាណិជ្ជកម្មអេឡិចត្រូនិកដ៏ទំនើប គួរឱ្យទុកចិត្ត និងងាយស្រួលប្រើប្រាស់ ដោយមានផលិតផលពិតប្រាកដក្នុងតម្លៃសមរម្យ។',
            'about.vision_title': 'ចក្ខុវិស័យរបស់យើង',
            'about.vision_desc': 'ក្លាយជាវេទិកាពាណិជ្ជកម្មអេឡិចត្រូនិកឈានមុខគេនៅកម្ពុជា ដែលទទួលបានការទុកចិត្តពីអតិថិជនរាប់លាននាក់ លើគុណភាព ភាពងាយស្រួល និងតម្លៃ។',
            'about.quality_title': 'ផលិតផលពិត 100%',
            'about.quality_desc': 'គ្រប់ផលិតផលទាំងអស់ត្រូវបាននាំចូលផ្ទាល់ពីអ្នកផ្គត់ផ្គង់ និងម៉ាកសញ្ញាដែលទទួលស្គាល់ច្បាស់លាស់។',
            'about.delivery_title': 'ដឹកជញ្ជូន 25 ខេត្ត/ក្រុង',
            'about.delivery_desc': 'ដឹកជញ្ជូនរហ័សទូទាំង 25 ខេត្ត/ក្រុង។ ភ្នំពេញ 1-2 ថ្ងៃ, តាមខេត្ត 3-5 ថ្ងៃធ្វើការ។',
            'about.customer_title': 'សេវាអតិថិជន 24/7',
            'about.customer_desc': 'ក្រុមការងារសេវាអតិថិជនរបស់យើងរង់ចាំជួយសម្រួល និងឆ្លើយតបសំណួររបស់អ្នកជានិច្ច តាមទូរស័ព្ទ អ៊ីមែល និង Telegram។',
            'about.offer_title': 'អ្វីដែលយើងផ្តល់ជូន',
            'about.offer_electronics': 'ឧបករណ៍អេឡិចត្រូនិក',
            'about.offer_electronics_desc': 'ទូរស័ព្ទ, គ្រឿងបន្លាស់, ឧបករណ៍ឆ្លាតវៃ',
            'about.offer_fashion': 'សម្លៀកបំពាក់ និងម៉ូដ',
            'about.offer_fashion_desc': 'ខោអាវ, ស្បែកជើង, កាបូប និងនាឡិកា',
            'about.offer_home': 'សម្ភារៈផ្ទះ និងការរស់នៅ',
            'about.offer_home_desc': 'គ្រឿងសង្ហារិម, សម្ភារៈផ្ទះបាយ, ការតុបតែងផ្ទះ',
            'about.offer_beauty': 'សុខភាព និងសម្ផស្ស',
            'about.offer_beauty_desc': 'ផលិតផលថែរក្សាស្បែក, គ្រឿងសំអាង',
            'about.payment_title': 'វិធីសាស្ត្រទូទាត់ប្រាក់',
            'about.payment_desc': 'យើងគាំទ្រវិធីសាស្ត្រទូទាត់ប្រាក់ដែលពេញនិយមបំផុតនៅកម្ពុជា ដើម្បីភាពងាយស្រួលរបស់អ្នក៖',
            'about.happy_customers': 'អតិថិជនពេញចិត្ត',
            'about.products': 'ផលិតផល',
            'about.provinces_covered': 'ខេត្ត/ក្រុងគ្របដណ្តប់',
            'about.support_available': 'សេវាគាំទ្រ 24/7',
            'about.contact_title': 'ទំនាក់ទំនង និងទីតាំង',
            'about.address_label': 'អាសយដ្ឋាន',
            'about.address_value': 'រាជធានីភ្នំពេញ, ប្រទេសកម្ពុជា',
            'about.phone_label': 'ទូរស័ព្ទ',
            'about.email_label': 'អ៊ីមែល',
            'about.hours_label': 'ម៉ោងធ្វើការ',
            'about.hours_value': 'ច័ន្ទ–សៅរ៍: 8:00 ព្រឹក – 8:00 យប់<br>អាទិត្យ: 9:00 ព្រឹក – 6:00 ល្ងាច',
            'about.cta_title': 'រួចរាល់ក្នុងការចាប់ផ្តើមទិញទំនិញ?',
            'about.cta_desc': 'ចូលរួមជាមួយអតិថិជនរាប់ពាន់នាក់ — ស្វែងរកផលិតផលដែលអ្នកពេញចិត្តឥឡូវនេះ។',
            'about.browse_products': 'មើលផលិតផល',
